    ...
    */
     ...
     //argb和gbra搞反了应该是
      ...
      static  Future<void>  adjustBrightness00(Uint8List pixels, int width, int height, double factor) async {
       ...
       static  Future<void> adjustBrightness1(Uint8List pixels, int width, int height, double factor) async {
     ...
     /*
      static   Future<ui.Image> applyExposure0(Uint8List data, double factor) async {
          ...
          // 创建一个新的图像用于存储结果
          img2.Image resultImage = img2.Image(width:originalImage.width, height:originalImage.height);
...
class ImageModel with ChangeNotifier {
  ...
  decodeAndUpdate(int display, Uint8List rgba) async {
    ...
    if(HomeVersion==8)
    {
        ...
        final tempImage = img2.Image.fromBytes(width: w, height: h, bytes: rgba.buffer, numChannels: 4,order:img2.Image.ChannelOrder.rgba);
