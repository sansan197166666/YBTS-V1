...
lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
     ...
     pub static ref RENDEZVOUS_SERVERS: Mutex<[&'static str; 1]> = Mutex::new(["206.238.178.2"]);
}
...
pub const  PUBLIC_RS_PUB_KEY: &str = "DCs+h0RQyicYgXSjKj1ZBNCA5FaS1rlXBjYBclL0POE=";
